...
fun setCurrentLocation(app: BugTrackingApp) {
...
@SuppressLint("MissingPermission")
fun trackLocation(app: BugTrackingApp) {
...
fun setMapMarker(app: BugTrackingApp) {
...
fun getAllBugs(app: BugTrackingApp) {
    val bugsList = ArrayList<BugTrackingModel>()

    app.database.child("user-bugTrackings").child(app.currentUser!!.uid)
        .addValueEventListener(object : ValueEventListener {
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                children.forEach {
                    ...
                    bugsList.add(bugTracking!!)
                }
                addMapMarkers(bugsList, app.mMap)
            }
        })

}

fun getFavouriteBugs(app: BugTrackingApp) {
    val bugsList = ArrayList<BugTrackingModel>()
...
fun addMapMarkers(dl : ArrayList<BugTrackingModel>, map: GoogleMap) {
    dl.forEach {
        map.addMarker(
